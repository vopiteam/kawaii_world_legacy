...
* Linux installed:
    * bin   = /usr/bin
    * share = /usr/share/KawaiiWorld
    * user  = ~/.KawaiiWorld
* macOS:
    * bin   = Contents/MacOS
    * share = Contents/Resources
    * user  = Contents/User OR ~/Library/Application Support/KawaiiWorld
...
-------------------
- Default location:
    $user/KawaiiWorld.conf
- It is created by KawaiiWorld when it is ran the first time.
- A specific file can be specified on the command line:
    --config <path-to-file>
- A run-in-place build will look for the configuration file in
    $location_of_exe/../KawaiiWorld.conf and also $location_of_exe/../../KawaiiWorld.conf
...
$ git clone --depth 1 https://github.com/KawaiiWorld/KawaiiWorld.git
$ cd KawaiiWorld

Download source, without using git:
$ wget https://github.com/KawaiiWorld/KawaiiWorld/archive/master.tar.gz
$ tar xf master.tar.gz
$ cd KawaiiWorld-master
...
General options:
    ...
    BUILD_CLIENT           - Build KawaiiWorld client
    BUILD_SERVER           - Build KawaiiWorld server
    ...
    VERSION_EXTRA          - Text to append to version (e.g. VERSION_EXTRA=foobar -> KawaiiWorld 0.4.9-foobar)
...
* You need:
	...
	* And, of course, KawaiiWorld:
		https://github.com/vopiteam/kawaii_world_legacy
* Steps:
	...
	* Select "Browse Source..." and select DIR/KawaiiWorld
	* Now, if using MSVC:
		* Select "Browse Build..." and select DIR/KawaiiWorld-build
	* Else if using MinGW:
		* Select "Browse Build..." and select DIR/KawaiiWorld
	* Select "Configure"
	...
	* Make sure the configuration is as follows
	  (note that the versions may differ for you):
                ...
                CMAKE_INSTALL_PREFIX     DIR/KawaiiWorld-install
	...
	* If you want to build 64-bit KawaiiWorld, you will need to build 64-bit version
	...
	* Hit "Generate"
	If using MSVC:
		* Open the generated KawaiiWorld.sln
		...
		* You should now have a working game with the executable in
			DIR/KawaiiWorld-install/bin/KawaiiWorld.exe
	...
	If using MinGW:
		...
		* You should now have a working game with the executable in
			DIR/KawaiiWorld/bin/KawaiiWorld.exe

### Bat script to build Windows releases of KawaiiWorld

This is how we build Windows releases.

    set sourcedir=%CD%
    set installpath="C:\tmp\KawaiiWorld_install"
