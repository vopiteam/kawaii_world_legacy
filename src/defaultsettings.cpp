...
void set_default_settings(Settings *settings) {
	...
	settings->setDefault("movement_speed_fast", "7.5");
	...
	if (false) {
		...
		settings->setDefault("client_mapblock_limit", "150");
		...
		// medium settings for 4.1-6GB RAM
			   ...
			   ([SDVersion deviceVersion] == iPadMini4) || ([SDVersion deviceVersion] == iPadAir) || ([SDVersion deviceVersion] == iPad5) ||
			   ([SDVersion deviceVersion] == iPad6) || ([SDVersion deviceVersion] == iPad7) || ([SDVersion deviceVersion] == iPadAir2)) {
		// medium settings
#endif
		...
		// high settings
		settings->setDefault("viewing_range", "65");
	...
	settings->setDefault("round_screen", "55");
	...
	if (safeAreaBottom > 0) {
		settings->setDefault("hud_move_upwards", "55");
		if SDVersioniPhone12Series
			settings->setDefault("round_screen", "125");
		else
			settings->setDefault("round_screen", "55");
	}
#endif // iOS
