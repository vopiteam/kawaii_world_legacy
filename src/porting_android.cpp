 ...
 */
extern "C" {
	JNIEXPORT void JNICALL Java_com_kawaiiworld_game_GameActivity_putMessageBoxResult(
			JNIEnv *env, jclass thiz, jstring text)
	{
		errorstream <<
			"Java_com_kawaiiworld_game_GameActivity_putMessageBoxResult got: " <<
			std::string((const char*) env->GetStringChars(text, nullptr)) << std::endl;
	}
	JNIEXPORT void JNICALL Java_com_kawaiiworld_game_GameActivity_pauseGame(
			JNIEnv *env, jclass clazz)
	{
		external_pause_game();
	}
	bool device_has_keyboard = false;
	JNIEXPORT void JNICALL Java_com_kawaiiworld_game_GameActivity_keyboardEvent(
...
void initAndroid()
{
	...
	nativeActivity = findClass("com/kawaiiworld/game/GameActivity");
